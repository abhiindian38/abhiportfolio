  ...
  en: {
    ...
    about: {
      ...
      education: {
        ...
        inter: {
          location: "Sri Chaitanya Junior Kalasala, Hyderabad",
          degree: "XII / Intermediate (Maths, Physics, Chemistry)",
          date: "2019 – 2021",
          marks: "Marks: 934 / 1000",
        },
        school: {
          location: "Sri Nagarjuna Vidyalaya High School, Hyderabad",
          degree: "X / Schooling (Maths, Science, Social Studies)",
          date: "2018 – 2019",
          gpa: "GPA: 9.70 / 10.0",
        },
      },
    ...
    footer: {
      description:
        "Computer Science student undergraduate from Marri Laxman Reddy Institute of Technology and Management, Hyderabad, passionate about web development and data structures.",
